  ...
  return (
    <MissionCard>
      <div className="flex  flex-column  flex-justify-content-center ">
        <h1 className="fs-800 text-secondary">About Us</h1>
        <Bar />
        ...
        <h3 className="fs-500  text-secondary "> Mission Statement</h3>
        <p className="fs-300 text-tertiary">
        ...
        <h3 className="fs-500 text-secondary "> Core values</h3>
        <p className="fs-300 text-tertiary">
          <p>
